...
#> [1] "communication, *p* = 0.715; fine motor, *p* = 0.987; gross motor, *p* = 0.357; problem solving, *p* = 0.292; personal-individual, *p* = 0.131"
```

Unlike the others, socio-individual domain was not influenced by corrected age (`r smooth["s(edad_corregida_meses)", expr]`). Accordingly, prematurity (measured in weeks) was not associated with any developmental domain within ASQ-3 assessment (significance for smooth terms: `r prematurity_smooths`).
