...
The same was observed when inspecting the effect of corrected age in the fine motor domain scores ($F_{smooth}$ (2.59, 226.77) = 4.2, *p* = 0.005), however it was not possible to estimate a significant overall effect ($\beta$ = 0.04, CI~95%~[-0.45, 0.52], $t_{student}$ (226.77) = 0.14, *p* = 0.886), nevertheless, it was only in the 22.3 to 38.3 age range where a significant negative effect was observed ($\beta$ = -0.79, CI~95%~[-1.45, -0.12], $t_{student}$ (226.77) = -2.34, *p* = 0.022).
